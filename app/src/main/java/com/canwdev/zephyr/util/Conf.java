...
public class Conf {
    ...
    public static final String HEWEATHER_CITY_LIST = "https://cdn.heweather.com/china-city-list.txt";
    public static final String HEWEATHER_REGISTER = "http://console.heweather.com/register";
    public static final String HEWEATHER_API_KEY1 = "74ac2716affa4279b5db3898be81c25d";
